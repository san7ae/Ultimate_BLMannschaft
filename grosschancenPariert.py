...
page = "https://www.ligainsider.de/bundesliga/ranking-top-10/grosschancen-pariert/"
pageTree = requests.get(page, headers=headers)
pageSoup = bs4.BeautifulSoup(pageTree.content, 'html.parser')

# Write to CSV data
outfile = open('grosschancenPariert.csv','w', encoding="utf-8", newline='')
...
for element in player_list:
    try:
        ...
        print(name)
        writer.writerow([name, verein, position, einsatz, spielminuten, grossChancenVereitelt, gesamtChancen])
    except:
