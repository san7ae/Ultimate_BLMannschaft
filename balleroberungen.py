...
page = "https://www.ligainsider.de/bundesliga/ranking-top-10/balleroberungen/"
pageTree = requests.get(page, headers=headers)
pageSoup = bs4.BeautifulSoup(pageTree.content, 'html.parser')

# Write to CSV data
outfile = open('balleroberungen.csv','w', encoding="utf-8", newline='')
...
for element in player_list:
    try:
        ...
        balleroberungenStr = element.findAll("td", {"class": "text-right"})[2].text
        balleroberungen = float(balleroberungenStr)
