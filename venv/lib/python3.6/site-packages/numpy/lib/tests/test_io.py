...
class TestSaveTxt(object):
    ...
    def test_unicode(self):
        ...
        with tempdir() as tmpdir:
            ...
            np.savetxt(os.path.join(tmpdir, 'example.csv'), a, fmt=['%s'],
                       encoding='UTF-8')
    ...
    def test_unicode_roundtrip(self):
        ...
        with tempdir() as tmpdir:
            for suffix in suffixes:
                np.savetxt(os.path.join(tmpdir, 'example.csv' + suffix), a,
                           fmt=['%s'], encoding='UTF-16-LE')
                b = np.loadtxt(os.path.join(tmpdir, 'example.csv' + suffix),
